...
if [[ -n "${POPULATE_CLIENTS_ARCH}" ]]; then
    ...
    sed -i "s|RHEL8_TOOLS_URL=.*|RHEL8_TOOLS_URL=\"${TOOLS_RHEL8}\"|" satellite6-populate.sh
    sed -i "s|RHEL8_TOOLS_PPC64LE_URL=.*|RHEL8_TOOLS_PPC64LE_URL=\"${TOOLS_RHEL8_PPC64LE}\"|" satellite6-populate.sh
    sed -i "s|RHEL8_TOOLS_S390X_URL=.*|RHEL8_TOOLS_S390X_URL=\"${TOOLS_RHEL8_S390X}\"|" satellite6-populate.sh
    sed -i "s|RHEL8_TOOLS_AARCH64_URL=.*|RHEL8_TOOLS_AARCH64_URL=\"${TOOLS_RHEL8_AARCH64}\"|" satellite6-populate.sh
fi
...
if [[ -n "${POPULATE_RHEL8}" ]]; then
    sed -i "s|POPULATE_RHEL8=.*|POPULATE_RHEL8=\"${POPULATE_RHEL8}\"|" satellite6-populate.sh
fi
